    ...
    import { View, Text, StyleSheet, TouchableOpacity, StatusBar, SafeAreaView, Animated, Dimensions, ScrollView } from "react-native";
    ...
    const Menu = () => {
        const { user, signOut, profissional } = useContext(AuthContext);
